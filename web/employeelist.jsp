            ...
            <c:forEach var="u" items="${findall}">
                <form action="employeeUpdateServlet" method="post">
                    <tr>
                        ...
                        <td><input type="text" value="${u.nation}" name="nation" size="3"></td>
                        <td><input type="text" value="${u.polic}" name="polic" size="3"></td>
                        <td><input type="text" value="${u.born}" name="born" size="10"></td>
                        <td><input type="text" value="${u.tel}" name="tel" size="10"></td>
                        <td><input type="text" value="${u.email}" name="email" size="10"></td>
                        <td><input type="text" value="${u.education}" name="education" size="5"></td>
                        <td><input type="text" value="${u.card_id}" name="card_id" size="12"></td>
                        <td><input type="text" value="${u.createdate}" name="createdate" size="12"></td>
                        <td>
